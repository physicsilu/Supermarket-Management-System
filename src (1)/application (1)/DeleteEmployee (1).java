...
public class DeleteEmployee extends JFrame {
    ...
    DeleteEmployee(){
        ...
        employeeIDlb = new JLabel("EMPLOYEE ID");
        employeeIDlb.setBounds(50,50,150,30);
        employeeIDlb.setFont(new Font("Tahoma", Font.PLAIN , 20));
        add(employeeIDlb);

        employeeIDtf = new JTextField();
        employeeIDtf.setBounds(250,50,150,30);
        add(employeeIDtf);
        ...
        submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae){
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "The Employee has been deleted successfully");
                    dispose();
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("deleteEmployee.jpg"));
